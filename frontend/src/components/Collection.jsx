  ...
  const products = [
    {
      ...
      title: 'Medaillons',
      description: 'A powerful stone for protection and energy enhancement.',
    },
    {
      ...
      title: 'Cotbag',
      description: 'A beautiful stone for emotional healing and balance.',
    },
    {
      ...
      title: 'Pyramides',
      description: 'A unique stone for spiritual growth and inner peace.',
    },
    {
  ...
  return (
    <section className="bg-white py-12 px-4 md:px-8">
      <div className="container mx-auto">
        <h2 className="text-2xl md:text-4xl font-bold mb-6">Our Esoteric Stone Collection</h2>
